# AWS Python HTTP API with Cognito Authorizer
...
The updated `httpAPi` section would look something like this:
    ...
    2    authorizers:
    3      serviceAuthorizer:
    4        identitySource: $request.header.Authorization
    5        issuerUrl: https://YOUR_AUTH0_DOMAIN.auth0.com
    6        audience: YOUR_API_ID
...
Have questions about the guide? [Get in touch](https://twitter.com/fmc_sea).
